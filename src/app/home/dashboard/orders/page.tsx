...
export default function OrderPage() {
  ...
  const { order, isLoading: isOrderLoading } = useAdminOrder(selectedOrderId || "")
                  ...
                  <TableBody>
                    {isOrdersLoading ? (
                      ...
                      orders.map((order) => (
                        <TableRow
                          key={order.id}
                          className="bg-accent cursor-pointer hover:bg-accent-hover"
                ...
                <div className="grid gap-3">
                  ...
                  <dl className="grid gap-3">
                    <div className="flex items-center justify-between">
                      ...
                      <dd>{order.customer.first_name}</dd>
                    </div>
                    <div className="flex items-center justify-between">
